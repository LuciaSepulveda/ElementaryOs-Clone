    ...
    >
      <VStack gap={[0, null, 10]}>
        ...
        >
          ...
          >
            {language !== "ES"
              ? "I have three years and a half of experience as a frontend developer, I have eager to contribute my skills and grow professionally in a new challenging role"
              : "Cuento con tres años de experiencia como desarrolladora frontend, tengo muchas ganas de aportar mis conocimientos y crecer profesionalmente en un nuevo puesto desafiante."}
          </MotionText>
        </Stack>
      </VStack>
    </VStack>
